        ...
        <div class="col-md-12">
            <div class="card" style="overflow: hidden;">
                ...
                <div style="margin-top: 20px;margin-bottom: -20px;">
                    ...
                    <p class="alert alert-success" role="alert"><strong>!Note</strong>{{session()->get('successfully')}}
                    </p>
                    @endif
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <small>Please enter secure password</small>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success btn-block" style="margin-top:30px"><i
                                class="fas fa-user-plus fa-fw"></i>@lang('site.add_member')</button>
                    </form>
                </div>
            </div>
        </div>
