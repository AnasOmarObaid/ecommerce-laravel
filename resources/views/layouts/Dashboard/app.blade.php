...
<head>
  ...
  @if (app()->getLocale() == 'ar')
  <link rel="stylesheet" href="{{asset('Dashboard/adminrtl/adminlte.rtl.min.css')}}">
  <link rel="stylesheet" href="{{asset('Dashboard/adminrtl/bootstrap.rtl.min.css')}}">
  <link rel="stylesheet" href="{{asset('Dashboard/adminrtl/fontawsome.rlt.css')}}">
  <link rel="stylesheet" href="{{asset('Dashboard/adminrtl/rtl.css')}}">
  @endif
</head>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index3.html" class="nav-link">@lang('site.dash')</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">@lang('site.content')</a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{url('dashboard/home')}}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">@lang('site.dash')</span>
      </a>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="{{url('dashboard/home')}}" class="nav-link">
                <i class="fas fa-home fa-fw logout-font"></i>
                <p>@lang('site.home')</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="{{route('show.department')}}" class="nav-link">
                <i class="fas fa-podcast fa-fw logout-font"></i>
                <p>@lang('site.department')</p>
              </a>
            </li>

            <li class="nav-item">
              <a href="{{url('dashboard/user/show')}}" class="nav-link">
                <i class="fas fa-users-cog fa-fw logout-font"></i>
                <p>@lang('site.user')</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="{{route('show.products')}}" class="nav-link">
                <i class="fab fa-product-hunt fa-fw logout-font"></i>
            ...
            <li class="nav-item">
              <a href="{{route('show.clients')}}" class="nav-link">
                <i class="fas fa-user-tie fa-fw logout-font"></i>
            ...
            <li class="nav-item">
              <a href="{{route('order.index')}}" class="nav-link">
                <i class="fas fa-folder-open fa-fw logout-font"></i>
                <p>Orders</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              ...
              <a href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault();
                ...
                <i class="fas fa-sign-out-alt fa-fw logout-font"></i>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2014-2019 <a href="#">Anas Omar</a>.</strong>
      All rights reserved.
